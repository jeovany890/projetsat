 ...
 */
final class Version20260309101511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE date_validation date_validation DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE campagne_phishing ADD consentement_obtenu TINYINT DEFAULT NULL, ADD date_consentement VARCHAR(255) DEFAULT NULL, ADD document_consentement VARCHAR(255) DEFAULT NULL, ADD formation_prealable_requise TINYINT DEFAULT NULL, ADD debriefing_automatique TINYINT DEFAULT NULL, ADD module_formation_associe_id INT DEFAULT NULL, CHANGE date_planifiee date_planifiee VARCHAR(255) NOT NULL, CHANGE date_debut date_debut VARCHAR(255) DEFAULT NULL, CHANGE date_termine date_termine VARCHAR(255) DEFAULT NULL, CHANGE date_creation date_creation VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE entreprise CHANGE date_creation date_creation VARCHAR(255) NOT NULL, CHANGE date_validation date_validation VARCHAR(255) DEFAULT NULL');
